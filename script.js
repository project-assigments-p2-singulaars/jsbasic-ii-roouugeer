...
//Escribe tu código aquí
 if (age >= 18) {
    ...
    console.log("No eres aún mmayor de edad")
 )
...
const result = weather === "soleado" ? "Me vestire con un vestido" : "Me vestiré con un pantalon"
...
const resultado = typeof value === 'number' ? "Es un número" : typeof value === 'string' ? "Es un string" : "No es ni número ni string";
...
console.log(("el area del rectangulo es " + areaRectangulo(10,4)))
console.log(("el area del rectangulo es " + areaRectangulo(2,3)))
console.log(("el area del rectangulo es " + areaRectangulo(3,80)))
console.log(("el area del rectangulo es " + areaRectangulo(23,56)))